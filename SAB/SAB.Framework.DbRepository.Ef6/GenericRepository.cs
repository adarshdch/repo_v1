...
{
    public sealed class GenericRepository<TEntity> : IGenericRepositoryAsync<TEntity> where TEntity : class, IObjectState
    {
        ...
        public GenericRepository(IDataContextAsync context, IUnitOfWorkAsync unitOfWork)
        {
            _context = context;
