...
namespace SAB.Framework.DbRepository.Ef6
{
    public class UnitOfWork : IUnitOfWorkAsync
    {
        ...
        public IGenericRepositoryAsync<TEntity> RepositoryAsync<TEntity>() where TEntity : class, IObjectState
        {
            if (ServiceLocator.IsLocationProviderSet)
            {
                return ServiceLocator.Current.GetInstance<IGenericRepositoryAsync<TEntity>>();
            }
